...
for i in range(1, 651):
  ...
  if house_input == "Saturn" or house_input == "saturn" or house_input == "satrun" or house_input == "Satrun":
    ...
    saturn_reaction_time_input = float(input("How long did your reaction take (in seconds)? >>>"))
    ...
    mars_reaction_time_input = float(input("How long did your reaction take (in seconds)? >>>"))
...
reaction_time.sort()
print("\n""The slowest reaction time was", reaction_time[0])
